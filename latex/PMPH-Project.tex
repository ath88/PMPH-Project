...
TODO write about why we can do this, ie. no accumulation in struct or nothin'
...
TODO heat dissipation algorithm, if its wrong, it really explodes after some time
...
we will only get a theoretical max speedup of factor 16. The overhead from 
creating processes, sharing result memory, and only having 16 concurrently 
running processes makes the results seem probable.

TODO elaborate on expectations of hyperthreading
